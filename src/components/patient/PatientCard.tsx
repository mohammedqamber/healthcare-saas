...
export function PatientCard({ patient }: { patient: Patient }) {
  return (
    <div className="group rounded-xl border border-border bg-white p-5 shadow-sm hover:shadow-md hover:border-[var(--primary)]/30 transition-all">
      <div className="flex items-start gap-3 mb-4">
        <div className="flex h-11 w-11 items-center justify-center rounded-full bg-[var(--accent)] text-sm font-bold text-[var(--primary)] shrink-0">
          {patient.name
            .split(" ")
            .map((n) => n[0])
            .join("")}
      ...
      <div className="space-y-2.5">
        <div className="flex items-center gap-2 text-xs">
          <Stethoscope className="h-3.5 w-3.5 text-[var(--muted-foreground)]" />
          <span className="text-[var(--foreground)]">{patient.condition}</span>
        </div>
        <div className="flex items-center gap-2 text-xs">
      ...
      <div className="mt-4 grid grid-cols-4 gap-2 rounded-lg bg-[var(--muted)] p-2.5">
        ...
        <div className="text-center">
          ...
          <p className="text-[9px] text-[var(--muted-foreground)]">SpO2%</p>
        </div>
        <div className="text-center">
